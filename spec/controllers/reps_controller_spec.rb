  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested rep" do
        ...
        Rep.any_instance.should_receive(:update_attributes).with({'these' => 'params'})
        put :update, {:id => rep.to_param, :rep => {'these' => 'params'}}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the rep as @rep" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Rep.any_instance.stub(:save).and_return(false)
        put :update, {:id => rep.to_param, :rep => {}}, valid_session
        assigns(:rep).should eq(rep)
      end
